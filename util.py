...
def calculate_am_or_pm(reminder_hour, am_or_pm):
    logger.log("calculate_am_or_pm | hour is: " + str(reminder_hour) + " and am or pm is: " + am_or_pm, "INFO")
    reminder_hour = int(reminder_hour)
    if (am_or_pm == "pm" and reminder_hour != 12):
        reminder_hour += 12
    elif (am_or_pm == "am" and reminder_hour == 12):
        reminder_hour = 0
    logger.log("calculate_am_or_pm | hour now is: " + str(reminder_hour) + " and am or pm is: " + am_or_pm, "INFO")
