...
def set_schedules():
    ...
    for channel in channels_with_scheduled_standups:
        ...
        sched.add_job(lambda channel_name=channel.channel_name: standup_call(channel.channel_name), 'cron', day_of_week='mon-fri', hour=0, minute=18, id=channel.channel_name)
