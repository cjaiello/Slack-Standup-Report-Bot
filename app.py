...
def confirm_success(form, email_confirmed, email):
    ...
    if form['hours_delay'] or form['minutes_delay']:
        response_message += " You have given the channel " + ((str(form['hours_delay']) + " hours") if form['hours_delay'] else "") + (" and " if form['hours_delay'] and form['minutes_delay'] else "") + ((str(form['minutes_delay']) + " minutes") if form['minutes_delay'] > 1 else "") + ((str(form['minutes_delay']) + " minute") if form['minutes_delay'] == 1 else "") + " to submit their standup status."
    else:
