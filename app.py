...
def set_email_job(channel):
    ...
    if (channel.email):
        ...
        SCHEDULER.add_job(get_timestamp_and_send_email, 'cron', [channel.channel_name, channel.email], day_of_week='mon-fri', hour=21, minute=6, id=channel.channel_name + "_sendemail")
